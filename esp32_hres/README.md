# SoftwareSerial_IR (ESP32 High-Resolution Port)
This is a high-resolution, non-blocking ESP32 port of the SoftwareSerial_IR library.
It uses CPU cycle counters for precise IR modulation frequency control and FreeRTOS tasks with `vTaskDelay` for graceful multitasking.
